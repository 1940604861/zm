...
<h3><?php echo $rows_dt['h4']; ?></h3>
<p class="p_1">作者：<?php echo $rows_dt['zhuozhe'];?> &nbsp;&nbsp;&nbsp;发布时间:<?php echo $rows_dt['date'];  ?></p>

<p class="p_2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rows_dt['new1'];?></p>

<p class="p_3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rows_dt['new2'];?></p>

<p class="p_4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rows_dt['new3'];?></p>

<p class="p_5">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rows_dt['new4'];?></p>

<p class="p_6">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rows_dt['new5'];?></p>

<div class="prev_next">
<p>上一篇：<a href="xinwen_dt.php?id=<?php echo $rows_dt_1['id'];?>"><?php echo $rows_dt_1['h4'];?></a></p>
<p>下一篇：<a href="xinwen_dt.php?id=<?php echo $rows_dt_2['id'];?>"><?php echo $rows_dt_2['h4'];?></a></p>
</div>
