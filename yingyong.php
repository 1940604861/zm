...
<meta charset="utf-8">
<title>无标题文档</title>
<link rel="stylesheet" type="text/css" href="css/yingyong.css">
...
$sql_yy="select * from yingyong order by id desc ";
$result_yy=mysql_query($sql_yy);
...
<?php $x=1;while($rows_yy=mysql_fetch_array($result_yy)){ ?>
<a href="yingyong_li.php?id=<?php echo $rows_yy['id'];?>">
<div class="san_right_1-2">
<img src="<?php $fileimg_yy="img_yingyong/".$rows_yy['img']; echo $fileimg_yy; ?>" width="430px" height="275px">
<p><?php echo $rows_yy['name']; ?></p>
</div>
</a>
<?php $x++; }?>
