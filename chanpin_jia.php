...
<meta charset="utf-8">
<title>无标题文档</title>
<link rel="stylesheet" type="text/css" href="css/chan_jia.css">
...
<div class="san_right_1_2"><img src="<?php echo $fileimg_jia; ?>" width="300px" height="300px;"></div>
<div class="san_right_1_3">
<h4>产品名称：<?php echo $rows_jia['name']; ?></h4>
<p><?php  echo $rows_jia['new']; ?></p>
</div>  <!--.san_righ_3t-->   
<div class="prev_next">
<p>上一篇：<a href="chanpin_jia.php?id=<?php echo $rows_jia_1['id'];?>"><?php echo $rows_jia_1['name'];?></a></p>
<p>下一篇：<a href="chanpin_jia.php?id=<?php echo $rows_jia_2['id'];?>"><?php echo $rows_jia_2['name'];?></a></p>
</div>
</div><!--.san_righ_1--> 
