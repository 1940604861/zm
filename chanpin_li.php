...
<div class="san_right_1_2"><img src="<?php echo $fileimg_li; ?>" width="300px" height="300px;"></div>
<div class="san_right_1_3">
<h4>产品名称：<?php echo $rows_li['name']; ?></h4>
<p><?php  echo $rows_li['new']; ?></p>
</div>  <!--.san_righ_3t-->   
<div class="prev_next">
<p>上一篇：<a href="chanpin_li.php?id=<?php echo $rows_li_1['id'];?>"><?php echo $rows_li_1['name'];?></a></p>
<p>下一篇：<a href="chanpin_li.php?id=<?php echo $rows_li_2['id'];?>"><?php echo $rows_li_2['name'];?></a></p>
</div>
</div><!--.san_righ_1--> 
