...
<div class="san_right">
<div class="san_right_table">
<h3><?php echo $rows_xw['h4']; ?></h3>
<p class="p_1">作者：<?php echo $rows_xw['zhuozhe'];?> &nbsp;&nbsp;&nbsp;发布时间:<?php echo $rows_xw['date'];  ?></p>

<p class="p_2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rows_xw['new1'];?></p>

<p class="p_3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rows_xw['new2'];?></p>

<p class="p_4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rows_xw['new3'];?></p>

<p class="p_5">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rows_xw['new4'];?></p>

<p class="p_6">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rows_xw['new5'];?></p>

<div class="prev_next">
<p>上一篇：<a href="xinwen_xw.php?id=<?php echo $rows_xw_1['id'];?>"><?php echo $rows_xw_1['h4'];?></a></p>
<p>下一篇：<a href="xinwen_xw.php?id=<?php echo $rows_xw_2['id'];?>"><?php echo $rows_xw_2['h4'];?></a></p>
</div>
